...
const registry = [
  ...
  },
  {
    ...
    method: "GET",
    ...exactPath("/api/chat/sessions"),
    schema: { input: { limit: "number" }, output: { sessions: "ChatSession[]", sharedScopes: "object" } },
    riskLevel: "low",
    readOnly: true,
    destructive: false,
    concurrencySafe: true,
  ...
  },
  {
    ...
    method: "POST",
    ...exactPath("/api/chat/sessions"),
    schema: { input: { styleProfileId: "string", title: "string" }, output: { session: "ChatSession" } },
    riskLevel: "medium",
    readOnly: false,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.devices.list",
    method: "GET",
    ...exactPath("/api/local-agent/devices"),
    schema: { input: null, output: { devices: "LocalAgentDevice[]" } },
    riskLevel: "low",
    readOnly: true,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.devices.create",
    method: "POST",
    ...exactPath("/api/local-agent/devices"),
    schema: { input: { name: "string", capabilities: "object" }, output: { device: "LocalAgentDevice", token: "string", runCommand: "string" } },
    riskLevel: "high",
    readOnly: false,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.devices.revoke",
    method: "POST",
    ...regexPath(/^\/api\/local-agent\/devices\/([^/]+)\/revoke$/, ["deviceId"]),
    schema: { input: { deviceId: "uuid" }, output: { device: "LocalAgentDevice" } },
    riskLevel: "high",
    readOnly: false,
    destructive: true,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.tasks.list",
    method: "GET",
    ...exactPath("/api/local-agent/tasks"),
    schema: { input: null, output: { tasks: "LocalAgentTask[]" } },
    riskLevel: "medium",
    readOnly: true,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.tasks.create",
    method: "POST",
    ...exactPath("/api/local-agent/tasks"),
    schema: { input: { deviceId: "string", taskType: "string", prompt: "string", chatSessionId: "string" }, output: { task: "LocalAgentTask" } },
    riskLevel: "high",
    readOnly: false,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.tasks.next",
    method: "GET",
    ...exactPath("/api/local-agent/tasks/next"),
    schema: { input: { authorization: "Bearer LocalAgentToken" }, output: { task: "LocalAgentTask|null" } },
    riskLevel: "high",
    readOnly: false,
    destructive: false,
    concurrencySafe: false,
  ...
  {
    name: "local_agent.tasks.status",
    method: "GET",
    ...regexPath(/^\/api\/local-agent\/tasks\/([^/]+)$/, ["taskId"]),
    schema: { input: { taskId: "uuid" }, output: { task: "LocalAgentTask" } },
    riskLevel: "medium",
    readOnly: true,
    destructive: false,
    concurrencySafe: true,
  ...
  {
    name: "local_agent.tasks.finish",
    method: "POST",
    ...regexPath(/^\/api\/local-agent\/tasks\/([^/]+)\/result$/, ["taskId"]),
    schema: { input: { status: "completed|failed", resultText: "string", errorText: "string" }, output: { task: "LocalAgentTask" } },
    riskLevel: "high",
    readOnly: false,
    destructive: false,
    concurrencySafe: false,
